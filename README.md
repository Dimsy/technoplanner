...
- **Управление весом задач**: Изменяйте продолжительность задач с помощью колесика мыши (влияет на Story Points)
- **Ключ задачи**: Уникальный идентификатор для каждой задачи
- **Story Points**: Оценка трудозатратности в сторипоинтах, определяющая ширину элемента
...
- `weight`: Вес задачи (в пикселях, рассчитывается как sp * 50)
- `type`: Тип задачи
- `key`: Ключ задачи для отображения
- `sp`: Story Points (трудозатратность, влияет на ширину элемента)
